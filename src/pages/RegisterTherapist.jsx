...
const RegisterTherapist = () => {
  ...
  const handleSubmit = async (values, { setFieldError }) => {
    ...
    const result = await register(values, 'therapist')
      ...
      <div className="max-w-md w-full">
        ...
        <div className="card">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Field
                      type="text"
                      name="crp"
                      className={`input-field ${errors.crp && touched.crp ? 'border-red-500' : ''}`}
                  ...
                  <div>
                    ...
                    <Field
                      type="text"
                      name="especialidade"
                      className={`input-field ${errors.especialidade && touched.especialidade ? 'border-red-500' : ''}`}
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <p className="text-sm text-gray-600">
              É paciente?{' '}
              <Link to="/register/paciente" className="text-primary-600 hover:text-primary-700 font-medium">
